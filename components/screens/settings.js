    ...
    <SafeAreaView tw={`relative`}>
        <ImageBackground 
           source={require("../../images/Settings.png")} 
            style={tw `h-full w-full mt-7`}
        >
            <Text style={tws`text-base text-3xl font-black text-yellow-5000 text-center`}>Settings</Text>
            <View style={tws`flex-row h-15 w-80 bg-yellow-5000  mx-5 mt-5 rounded-full`}>
                    <Image source = {require("../../images/profilepic.png")}
                    style={tw`border-black h-10 w-10 mt-3 ml-4 border-black`}/>
                    <Ionicons name="cloud" size={24} color="black" style={tw`relative  ml-55 mt-5 `}/>
            </View>
            ...
            <View style={tw`pt-10 `}>
                ...
                <Line/>
                <Text style={styles.text}><Ionicons name="swap-vertical-outline" size={24} color="#F2E0C2"/> Version(1.0.0)            {<Text style={tws`text-blue-710`}>Check Update</Text>}</Text>
            </View>
        </ImageBackground>
    </SafeAreaView>
    )
